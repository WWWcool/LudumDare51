...
namespace GoogleSheetsToUnity
{
    ...
    {      
        ...
        /// <returns></returns>
        private static IEnumerator Read(WWW request, string titleColumn, int titleRow, OnSpreedSheetLoaded callback)
        {
            yield return request;

            var rawData = JSON.Load(request.text).Make<ValueRange>();
